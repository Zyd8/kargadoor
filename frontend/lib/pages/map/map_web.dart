...
class MapPagePlatform extends StatefulWidget {
  final String apiKey;
  const MapPagePlatform({super.key, required this.apiKey});

  @override
  State<MapPagePlatform> createState() => _MapPageWebState();
}

class _MapPageWebState extends State<MapPagePlatform> {
  ...
  Future<String?> _reverseGeocode(double lat, double lng) async {
    try {
      ...
      if (response.status == 200) {
        ...
        // This is a simplified version - you might want to use dart:convert for proper JSON parsing
        return 'Current Location'; // Placeholder - implement proper parsing
      }
    } catch (e) {
